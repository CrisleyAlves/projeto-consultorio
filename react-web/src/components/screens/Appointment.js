...
import List from "../ui/appointment/List";
import Form from "../ui/appointment/Form";
import Update from "../ui/appointment/Update";
...
export default class Appointment extends Component{
    ...
    insertNewInfo = (appointment) => {
        crud.insert(this.state.module, appointment).then((response)=>{
    ...
    updateInfo = (appointment) => {
        crud.update(this.state.module, appointment).then((response)=>{
