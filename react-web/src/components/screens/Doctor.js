...
import List from "../ui/doctor/List";
import Form from "../ui/doctor/Form";
import Update from "../ui/doctor/Update";
...
export default class Medico extends Component{
    ...
    insertNewInfo = (doctor) => {
        crud.insert(this.state.module, doctor).then((response)=>{
    ...
    updateInfo = (doctor) => {
         crud.update(this.state.module, doctor).then((response)=>{
