            ...
            if(response.status === 200){
                this.setState(()=>{
                    return{
                        ...
                        date: moment(response.data.date,  moment.ISO_8601),
                        doctor: response.data.doctor,
                        exams: response.data.exams,
                        pacient: response.data.pacient,
                        totalPrice: response.data.totalPrice,
                        beforeAppointment: response.data.beforeAppointment,
                        afterAppointment: response.data.afterAppointment,
                        pesquisaCpf: response.data.pacient.cpf,
                        pesquisaCrm: response.data.doctor.crm
                    }
                })
            }
        })
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form className="form-horizontal" id="formSubmit" onSubmit={this.handleSubmitForm}>
                        ...
                        <div className="form-group row">
                            <label className="col-md-3 col-form-label" htmlFor="text-input">Total</label>
                            <div className="col-md-2">
